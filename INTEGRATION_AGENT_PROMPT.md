# CPI Auth — Integration Prompt for AI Agents

Copy this prompt into your AI agent's context when you want it to integrate CPI Auth into an application.

Replace the placeholder values (`<...>`) with your actual configuration before pasting.
